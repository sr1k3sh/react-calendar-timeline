...
var Columns = /** @class */ (function (_super) {
    ...
    Columns.prototype.render = function () {
        ...
        var lines = [];
        iterateTimes(canvasTimeStart, canvasTimeEnd, minUnit, timeZone, timeSteps, function (time, nextTime) {
    ...
    Columns.propTypes = __assign(__assign({}, passThroughPropTypes), { timeZone: PropTypes.string, getLeftOffsetFromDate: PropTypes.func.isRequired });
    return Columns;
}(Component));
