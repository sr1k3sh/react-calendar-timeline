    ...
    value: function render() {
      ...
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
        ...
        if (verticalLineClassNamesForTime) {
          classNamesForTime = verticalLineClassNamesForTime((0, _dateFns.getUnixTime)(time) * 1000, // turn into ms, which is what verticalLineClassNamesForTime expects
          (0, _dateFns.getUnixTime)(nextTime) * 1000 - 1);
        } // TODO: rename or remove class that has reference to vertical-line


        var classNames = 'rct-vl' + (firstOfType ? ' rct-vl-first' : '') + (minUnit === 'day' || minUnit === 'hour' || minUnit === 'minute' ? " rct-day-".concat((0, _dateFns.getDay)(time), " ") : '') + classNamesForTime.join(' ');
        var left = getLeftOffsetFromDate((0, _dateFns.getTime)(time));
        var right = getLeftOffsetFromDate((0, _dateFns.getTime)(nextTime));
        lines.push( /*#__PURE__*/_react["default"].createElement("div", {
          key: "line-".concat((0, _dateFns.getTime)(time)),
