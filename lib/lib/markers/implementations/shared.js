...
var createMarkerStylesWithLeftOffset = function (leftOffset) { return (__assign(__assign({}, criticalStyles), { left: leftOffset })); };
exports.createMarkerStylesWithLeftOffset = createMarkerStylesWithLeftOffset;
var createDefaultRenderer = function (dataTestidValue) {
    // eslint-disable-next-line
    return function DefaultMarkerRenderer(_a) {
        var styles = _a.styles;
        return (0, jsx_runtime_1.jsx)("div", { style: styles, "data-testid": dataTestidValue }, void 0);
    };
};
