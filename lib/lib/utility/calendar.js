...
var startOfMap = {
  ...
  quarter: _dateFns.startOfQuarter,
  month: _dateFns.startOfMonth,
  week: _dateFns.startOfWeek,
  isoWeek: _dateFns.startOfISOWeek,
  day: _dateFns.startOfDay,
  date: _dateFns.startOfDay,
  hour: _dateFns.startOfHour,
  minute: _dateFns.startOfMinute,
  second: _dateFns.startOfSecond
};
var endOfMap = {
  year: _dateFns.endOfYear,
  quarter: _dateFns.endOfQuarter,
  month: _dateFns.endOfMonth,
  week: _dateFns.endOfWeek,
  isoWeek: _dateFns.endOfISOWeek,
  day: _dateFns.endOfDay,
  date: _dateFns.endOfDay,
  hour: _dateFns.endOfHour,
  minute: _dateFns.endOfMinute,
  second: _dateFns.endOfSecond
};
var addMap = {
  year: _dateFns.addYears,
  quarter: _dateFns.addQuarters,
  month: _dateFns.addMonths,
  week: _dateFns.addWeeks,
  day: _dateFns.addDays,
  hour: _dateFns.addHours,
  minute: _dateFns.addMinutes,
  second: _dateFns.addSeconds,
  millisecond: _dateFns.addMilliseconds
};
var getMap = {
  year: _dateFns.getYear,
  month: _dateFns.getMonth,
  date: _dateFns.getDate,
  hour: _dateFns.getHours,
  minute: _dateFns.getMinutes,
  second: _dateFns.getSeconds,
  millisecond: _dateFns.getMilliseconds
};
var setMap = {
  year: _dateFns.setYear,
  month: _dateFns.setMonth,
  date: _dateFns.setDate,
  hour: _dateFns.setHours,
  minute: _dateFns.setMinutes,
  second: _dateFns.setSeconds,
  millisecond: _dateFns.setMilliseconds
};
/**
...
function iterateTimes(start, end, unit, timeSteps, callback) {
  var time = startOfMap[unit](new Date(start));
  ...
  while ((0, _dateFns.getTime)(time) < end) {
