...
var ReactCalendarTimeline = /** @class */ (function (_super) {
    ...
    function ReactCalendarTimeline(props) {
        ...
        _this.getTimeFromRowClickEvent = function (e) {
            ...
            var _a = _this.state, width = _a.width, canvasTimeStart = _a.canvasTimeStart, canvasTimeEnd = _a.canvasTimeEnd;
            // this gives us distance from left of row element, so event is in
            // context of the row element, not client or page
            var offsetX = e.nativeEvent.offsetX;
            var time = calculateTimeForXPosition(canvasTimeStart, canvasTimeEnd, getCanvasWidth(width), offsetX);
        ...
        var canvasWidth = getCanvasWidth(_this.state.width);
    ...
    ReactCalendarTimeline.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (visibleTimeStart && visibleTimeEnd) {
            ...
            var canvasWidth = getCanvasWidth(prevState.width);
    ...
    ReactCalendarTimeline.prototype.render = function () {
        var _this = this;
        var _a = this.props, items = _a.items, groups = _a.groups, sidebarWidth = _a.sidebarWidth, rightSidebarWidth = _a.rightSidebarWidth, timeSteps = _a.timeSteps, traditionalZoom = _a.traditionalZoom;
