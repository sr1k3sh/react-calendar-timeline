...
var CustomHeader = /** @class */ (function (_super) {
    ...
    function CustomHeader(props) {
        ...
        _this.getHeaderIntervals = function (_a) {
            var canvasTimeStart = _a.canvasTimeStart, canvasTimeEnd = _a.canvasTimeEnd, unit = _a.unit, timeZone = _a.timeZone, timeSteps = _a.timeSteps, getLeftOffsetFromDate = _a.getLeftOffsetFromDate;
            var intervals = [];
            (0, calendar_1.iterateTimes)(canvasTimeStart, canvasTimeEnd, unit, timeZone, timeSteps, function (startTime, endTime) {
                var left = getLeftOffsetFromDate((0, date_fns_1.getTime)(startTime));
                var right = getLeftOffsetFromDate((0, date_fns_1.getTime)(endTime));
        ...
        _this.getIntervalProps = function (props) {
            ...
            return {
                ...
                key: "label-" + (0, date_fns_1.getTime)(startTime)
            };
        };
        ...
        var canvasTimeStart = props.canvasTimeStart, canvasTimeEnd = props.canvasTimeEnd, canvasWidth = props.canvasWidth, unit = props.unit, timeZone = props.timeZone, timeSteps = props.timeSteps, showPeriod = props.showPeriod, getLeftOffsetFromDate = props.getLeftOffsetFromDate;
    ...
    CustomHeader.prototype.componentWillReceiveProps = function (nextProps) {
        if (nextProps.canvasTimeStart !== this.props.canvasTimeStart ||
            ...
            nextProps.timeSteps !== this.props.timeSteps ||
            nextProps.showPeriod !== this.props.showPeriod) {
            var canvasTimeStart = nextProps.canvasTimeStart, canvasTimeEnd = nextProps.canvasTimeEnd, canvasWidth = nextProps.canvasWidth, unit = nextProps.unit, timeZone = nextProps.timeZone, timeSteps = nextProps.timeSteps, showPeriod = nextProps.showPeriod, getLeftOffsetFromDate = nextProps.getLeftOffsetFromDate;
...
var CustomHeaderWrapper = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(TimelineStateContext_1.TimelineStateConsumer, { children: function (_a) {
            ...
            return ((0, jsx_runtime_1.jsx)(HeadersContext_1.TimelineHeadersConsumer, { children: function (_a) {
                    ...
                    return ((0, jsx_runtime_1.jsx)(CustomHeader, __assign({ children: children, timeSteps: timeSteps, showPeriod: showPeriod, unit: unit ? unit : timelineState.timelineUnit }, timelineState, { headerData: headerData, getLeftOffsetFromDate: getLeftOffsetFromDate, height: height }), void 0));
                } }, void 0));
        } }, void 0));
};
