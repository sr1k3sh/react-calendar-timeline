  ...
  function DateHeader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getLabelFormat", function (interval, unit, labelWidth) {
      ...
      if (typeof labelFormat === 'string') {
        ...
        return (0, _dateFns.format)(startTime, labelFormat, {
...
_defineProperty(DateHeader, "contextType", _DateContext["default"]);
...
function formatLabel(_ref3, unit, labelWidth, dateContext) {
  var _ref4 = _slicedToArray(_ref3, 2),
      timeStart = _ref4[0],
      timeEnd = _ref4[1];

  var formatOptions = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _defaultConfig.defaultHeaderFormats;
  var format;
  ...
  return (0, _dateFns.format)(timeStart, format, {
