...
var ScrollElement = /** @class */ (function (_super) {
    ...
    function ScrollElement() {
        ...
        _this.handleWheel = function (e) {
            ...
            if (e.ctrlKey || e.metaKey || e.altKey) {
                e.preventDefault();
                var parentPosition = (0, dom_helpers_1.getParentPosition)(e.currentTarget);
    ...
    ScrollElement.prototype.render = function () {
        ...
        return ((0, jsx_runtime_1.jsx)("div", __assign({ ref: this.refHandler, "data-testid": "scroll-element", className: "rct-scroll", style: scrollComponentStyle, onMouseDown: this.handleMouseDown, onMouseMove: this.handleMouseMove, onMouseUp: this.handleMouseUp, onMouseLeave: this.handleMouseLeave, onTouchStart: this.handleTouchStart, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd, onScroll: this.handleScroll }, { children: children }), void 0));
    };
    ScrollElement.propTypes = {
        children: prop_types_1.default.element.isRequired,
        width: prop_types_1.default.number.isRequired,
        height: prop_types_1.default.number.isRequired,
        traditionalZoom: prop_types_1.default.bool.isRequired,
        scrollRef: prop_types_1.default.func.isRequired,
        isInteractingWithItem: prop_types_1.default.bool.isRequired,
        onZoom: prop_types_1.default.func.isRequired,
        onWheelZoom: prop_types_1.default.func.isRequired,
